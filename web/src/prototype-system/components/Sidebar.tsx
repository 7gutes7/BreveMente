...
export const Sidebar: React.FC<SidebarProps> = ({ userRole, onLogout }) => {
  ...
  return (
    <aside className="w-64 bg-clinical-dark text-white flex flex-col shrink-0 h-screen shadow-lg border-r border-slate-800">
      ...
      {/* Logout Footer & Return to Web */}
      <div className="p-4 border-t border-slate-800 shrink-0 space-y-1">
        <a
          href="/"
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800 transition-all font-semibold text-xs text-left"
        >
